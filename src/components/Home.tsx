...
const Home = memo(function Home({ setLoading }: HomeProps) {
  ...
  const RESUME_URL = "https://drive.google.com/file/d/1UJA87j1UvrIHv7-fGhpSxzObj2iFHUUd/view?usp=sharing"
  ...
  return (
    <section id="home" className="min-h-screen w-full pt-16 md:pt-20 pb-4 md:pb-8 flex items-center px-3 md:px-0" aria-label="Krishna N Acharya - Home Section" data-name="home">
      <div className='max-w-[1440px] w-full mx-auto flex flex-col items-center justify-center px-3 md:px-10 md:flex-row md:gap-20'>
        <header className='flex flex-col justify-center w-full text-center md:text-left md:w-3/5'>
          ...
          <div ref={buttonRef} className="w-full md:w-auto hidden md:block">
            <a href={RESUME_URL} target="_blank" rel="noopener noreferrer" className="w-full md:w-auto">
