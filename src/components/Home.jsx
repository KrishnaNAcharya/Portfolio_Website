...
const Home = memo(function Home({ setLoading }) {
  ...
  return (
    <section id="home" name="home" className="min-h-screen w-full pt-16 md:pt-20 pb-4 md:pb-8 flex items-center px-3 md:px-0" aria-label="Krishna N Acharya - Home Section">
    ...
    <span className='animate-shine text-4xl sm:text-5xl md:text-[5.8rem]' aria-label="Krishna" style={{ fontFamily: '"Great Vibes", "Dancing Script", cursive', fontWeight: '500', letterSpacing: '0.05em' }}>
      Krishna
          ...
          <div ref={buttonRef} className="w-full md:w-auto hidden md:block">
            <a href="https://drive.google.com/file/d/15jZJ2p3_6xubIQ5ZxI1bFbqpHfyTFiDn/view?usp=sharing" target="_blank" rel="noopener noreferrer" 
