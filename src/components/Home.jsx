    ...
    <div name="home" className="h-screen w-full bg-gradient-to-b from-black via-black to-gray-800">
      <div className='max-w-screen-xl w-full mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row'>
        <div className='flex flex-col justify-center h-full w-full text-center md:text-left'>
          {/* Increased margin top for the heading */}
          <h2 className='text-4xl sm:text-7xl font-bold text-white mt-48'>
            Hello there! My name is {" "}
            <span className='animate-shine'>
              Krishna
            </span>.
          </h2>
          <p className="text-white text-xl py-4 max-w-2xl text-justify leading-relaxed">
        ...
        <div className='mt-10 md:mt-0 md:ml-8 w-full'>
