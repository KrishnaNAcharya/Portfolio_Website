...
A modern, responsive portfolio website showcasing my journey as a Full-Stack Developer and AI Enthusiast. Built with **Next.js 14**, **TypeScript**, and enhanced with stunning animations and comprehensive SEO optimizations.
...
## ⚡ Features
- **Modern Tech Stack**: Next.js 14 + TypeScript for production-ready applications
...
git clone https://github.com/KrishnaNAcharya/personalportfolio.git
...
npm run check-types  # Check TypeScript without emitting
```
...
### Migration Journey
- ✅ **Complete Migration**: From React+Vite to Next.js 14 with TypeScript
...
**Built with ❤️ by Krishna N Acharya** | **Powered by Next.js 14 + TypeScript**
